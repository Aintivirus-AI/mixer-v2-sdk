import {
  ...
  UnclaimedRewardsRecovered as UnclaimedRewardsRecoveredEvent,
...
export function handleUnclaimedRewardsRecovered(
  event: UnclaimedRewardsRecoveredEvent,
): void {
  let entity = new UnclaimedRewardsRecovered(eventEntityId(event));
  entity.asset = event.params.asset;
